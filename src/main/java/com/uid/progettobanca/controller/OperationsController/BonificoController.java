...
public class BonificoController {
    ...
    void onSendButtonClick(ActionEvent event) {
        ...
        try {
            ContiDAO.transazione(BankApplication.getCurrentlyLoggedIban(), fieldIbanTo.getText(), BankApplication.getCurrentlyLoggedMainSpace(), Double.parseDouble(fieldAmount.getText()));
